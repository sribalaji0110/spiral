...
$(function() {
    ...
    jQuery(".menubar-top").on("click", function() {
        ...
        var logoheaderHTML = jQuery("<div>")
            .append($(".header-nav .logo-header").clone())
            .html();
        var navbarHTML = jQuery("<div>")
            .append($(".header-nav .navbar-nav").clone())
            .html();
        var footermenuHTML = jQuery("<div>")
            .append($(".header-nav .footer-menu").clone())
            .html();
        jQuery(".content-scroll").removeClass(
            "content-scroll mCustomScrollbar _mCS_1 mCS_no_scrollbar"
        );
        jQuery(".header-nav").empty();
        jQuery(".header-nav")
            .append(logoheaderHTML)
            .append(navbarHTML)
            .append(footermenuHTML);
...
jQuery(window).on("load", function() {
    ...
    jQuery(document).on(
        "click",
        ".theme-panel-save li a, .theme-panel-save li img",
        function() {
    ...
    jQuery.each(themeOption, function(index, themeOptionItem) {
        ...
        if (themeOptionItemValue != "" && themeOptionItemValue != 1) {
            if (themeOptionItem == "themeStandardColor") {
                ...
                setTimeout(function() {
                    jQuery(
                        "." + themeOptionItem + "-view " + " ." + themeOptionItemValue
                    ).addClass("active");
                }, 300);
